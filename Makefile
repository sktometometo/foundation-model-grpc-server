all:
	python -m grpc_tools.protoc -I./proto --python_out=./src/foundation_model_grpc_interface --pyi_out=./src/foundation_model_grpc_interface --grpc_python_out=./src/foundation_model_grpc_interface ./proto/lavis-server.proto

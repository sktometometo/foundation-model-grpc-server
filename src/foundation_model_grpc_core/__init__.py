...
import cv2
import grpc
from foundation_model_grpc_interface import lavis_server_pb2, lavis_server_pb2_grpc
...
def main_client_sample():
    ...
    parser.add_argument(
        ...
        type=str,
        help="Task type, options are 'image_captioning', 'instructed_generation', 'text_localization', 'vqa'",
    )
